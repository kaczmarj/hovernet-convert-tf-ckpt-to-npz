#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Script to convert hovernet tensorflow checkpoints to numpy npz files.

This requires tensorflow 1.12.0 and tensorpack 0.9.0.1.
Tested with python 3.6.

This script is originally from
https://github.com/vqdang/hover_net/issues/126#issuecomment-850447589
by @vqdang on GitHub.
"""
...
def guess_inputs(input_dir):
    ...
    if len(model_candidates) > 1:
        logger.info(
            "Choosing {} from {} as model file.".format(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        dest="input", help="input model file, has to be a TF checkpoint"
    )
    parser.add_argument(
        dest="output", help="output model file, can be npz or TF checkpoint"
    )
